...
const atecc = require("node-atecc");
...
HSMWalletProvider.prototype.sendAsync = function() {
  this.engine.sendAsync.apply(this.engine, arguments);
};

HSMWalletProvider.prototype.send = function() {
  return this.engine.send.apply(this.engine, arguments);
};

// returns the address of the given address_index, first checking the cache
HSMWalletProvider.prototype.getAddress = function(idx) {
...
HSMWalletProvider.prototype.getAddresses = function() {
  return this.addresses;
};

module.exports = HSMWalletProvider;
